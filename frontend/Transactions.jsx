...
function Transactions() {
  ...
  return (
    ...
    <div className="bg-white rounded-xl shadow-lg overflow-hidden ml-2 ">

      <div className="px-4 py-2">
        <h2 className="text-1xl text-left font-normal text-gray-500">
          Recent Transactions
        </h2>
      </div>
      ...
      <table >
        ...
        <thead className="bg-gray-100">
          <tr>
            <th className="px-4 py-2 text-left text-[13px] font-normal">Date</th>
            <th className="px-4 py-2 text-left text-[13px] font-normal">Category</th>
            <th className="px-4 py-2 text-left text-[13px] font-normal">Payment Mode</th>
            <th className="px-4 py-2 text-left text-[13px] font-normal">Description</th>
            <th className="px-4 py-2 text-left text-[13px] font-normal">Amount</th>
            <th className="px-4 py-2 text-left text-[13px] font-normal">Action</th>
        ...
        <tbody>
          ...
          {transactions.map((item) => (
            ...
            <tr
              key={item.id}
              className=" hover:bg-gray-50 transition text-1xl text-[11px] font-normal"
            >
              <td className="px-4 py-2 text-1xl">{item.date}</td>

              <td className="px-4 py-2 text-1xl">{item.category}</td>

              <td className="px-4 py-2 text-1xl">{item.paymentMode}</td>

              <td className="px-4 py-2 text-1xl">{item.description}</td>
              ...
              <td className="px-4 py-2 text-1xl">{item.Action}
                  <div className="flex w-6 items-center h-2  mt-1">
